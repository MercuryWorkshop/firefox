...
// JS -> WebAssembly JIT.
//
// The JS->wasm-bytecode JIT lives in the WasmJit*.cpp modules (front-end:
// WasmJitWarp.cpp; back-end: WasmJitBackend.cpp; runtime/host glue:
// WasmJitRuntime.cpp). It exposes js::wasm::WasmJitObserveCall /
// WasmJitRunCall and the extern "C" host entry points (wjhelp, WJTraceRoots,
// wasmjit_invoke). The pre-rewrite hand-rolled implementation is preserved
// verbatim in WasmJS.cpp.jitref for reference.
// ===========================================================================
